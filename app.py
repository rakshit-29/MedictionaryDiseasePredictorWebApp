...
def main():
    ...
    st.set_option('deprecation.showPyplotGlobalUse', False)
    if st.checkbox("Pie Graph"):
        all_columns_names = df.columns.tolist()
        if st.button("Generate Pie Graph"):
    ...
    displayed_results = [choice_itch, choice_skin_rash, choice_nodalskin, choice_consnz, choice_shiv, choice_chills,
                         ...
                         choice_dhd, choice_indigestion, choice_headache, choice_ylwskin, choice_drkur, choice_nausea,
                         ...
                         choice_sw_ly_nd, choice_malaise, choice_blurry_vision, choice_phlegm, choice_throat_irritation,
                         choice_red_eyes,
                         ...
                         choice_puffy_face, choice_enlarged_thyroid, choice_brittle_nails, choice_swollen_extremities,
    ...
    st.sidebar.info("Medictionary Disease Prediction Tool")
    if st.sidebar.button("About"):
        st.sidebar.text("Made By Rakshit Saxena")
        st.sidebar.text("Web Health Informatics, 2021")
